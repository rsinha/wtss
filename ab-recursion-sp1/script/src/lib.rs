use ab_rotation_lib::{address_book::AddressBook, signers::SigningKeys, statement::Statement};
use sp1_sdk::SP1ProofWithPublicValues;

pub fn generate_statement<const VALIDATORS_COUNT: usize>(
    ab_curr_validators: &SigningKeys<VALIDATORS_COUNT>,
    ...
    let signatures = ab_rotation_lib::ed25519::Signatures(
        ab_curr_validators
            .all_sign(VALIDATORS_COUNT, &message)
            .to_vec()
            .into(),
    );
